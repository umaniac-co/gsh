...
enum {
    ...
    GSH_OPTION_PIPEFAIL = 1U << 4,
    GSH_OPTION_HASHALL = 1U << 5,
    GSH_OPTION_NOEXEC = 1U << 6,
    GSH_OPTION_NOLOG = 1U << 7,
    GSH_OPTION_IGNOREEOF = 1U << 8,
    GSH_OPTION_NOTIFY = 1U << 9,
    GSH_OPTION_VERBOSE = 1U << 10,
    GSH_OPTION_XTRACE = 1U << 11,
    GSH_OPTION_ERREXIT = 1U << 12,
